<nav class="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-gray-100" x-data="{ mobileOpen: false }">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-6">
                ...
                <a href="{{ url('/#cara-kerja') }}" class="text-sm text-gray-600 hover:text-gray-900">Cara Kerja</a>
    ...
    <div x-show="mobileOpen" x-transition class="md:hidden border-t border-gray-100 bg-white">
        <div class="px-4 py-3 space-y-1">
            ...
            <a href="{{ url('/#cara-kerja') }}" class="block px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-gray-50">Cara Kerja</a>

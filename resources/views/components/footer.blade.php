    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
                <a href="{{ url('/') }}" class="text-lg font-bold text-white">Auto<span class="text-indigo-400">pahala</span></a>
                <p class="mt-2 text-sm text-gray-400 max-w-sm leading-relaxed">

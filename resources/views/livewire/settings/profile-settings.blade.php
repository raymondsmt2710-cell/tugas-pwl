    ...
    <form wire:submit="save" class="px-6 py-5 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input wire:model="bank_account_number" type="text" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Masukkan nomor rekening Anda">

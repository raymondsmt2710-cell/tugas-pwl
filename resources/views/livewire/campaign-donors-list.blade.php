    ...
    <div class="mb-6">
        <div class="relative rounded-xl shadow-sm">
            ...
            <input type="text" 
                   ...
                   class="block w-full pl-10 pr-4 py-2.5 border border-gray-200 focus:border-brand-500 focus:ring-brand-500 rounded-xl text-sm placeholder-gray-400" 
                   placeholder="Cari nama donatur atau doa...">
        </div>
    </div>

                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-6">
                        ...
                        <div class="mt-5 pt-5 border-t border-gray-100 flex items-center justify-between" x-data="{ 
                            liked: {{ auth()->check() && $campaign->isLikedByUser(auth()->id()) ? 'true' : 'false' }},
                            ...
                            <button @click="toggleLike()" class="flex items-center gap-2 group focus:outline-none transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                     :class="liked ? 'text-red-500 fill-red-500 scale-105' : 'text-gray-400 hover:text-red-500'" 
                                ...
                                <span class="text-sm font-semibold text-gray-700" x-text="likesCount + (likesCount === 1 ? ' Like' : ' Likes')"></span>
                            </button>

                                ...
                                <div class="space-y-4">
                                    @foreach($comments as $c)
                                        <div class="flex items-start gap-3">
                                            ...
                                            @else
                                                <div class="w-9 h-9 rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center text-xs text-gray-400 font-bold shrink-0">?</div>
                                            @endif
                                            {{-- Comment Content --}}
                                            <div class="flex-1 text-left">
                                                <div class="bg-gray-50 rounded-2xl px-4 py-3 border border-gray-100/30">
                                                    <div class="flex items-baseline flex-wrap gap-x-1.5">
                                                        ...
                                                        @else
                                                            <span class="font-bold text-gray-400 text-sm">Akun Dihapus</span>
                                                        @endif

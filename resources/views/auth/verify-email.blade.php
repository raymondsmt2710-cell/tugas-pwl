    ...
    <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="text-center">
                <a href="/" class="text-2xl font-bold text-gray-900">Auto<span class="text-brand-500">pahala</span></a>
            </div>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-6 shadow-sm sm:rounded-2xl border border-gray-100">
                ...
                <div class="text-center mb-6">
                    <div class="w-20 h-20 mx-auto rounded-full bg-brand-50 flex items-center justify-center">
                ...
                <form method="POST" action="{{ route('verification.send') }}" id="resend-form">
                    @csrf
                    <button type="submit" id="resend-btn" class="w-full py-3 px-4 rounded-xl bg-brand-500 text-white font-semibold text-sm hover:bg-brand-600 shadow-sm transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-brand-500">
            ...
            <p class="mt-6 text-center text-xs text-gray-400">
                Butuh bantuan? <a href="mailto:tubespwlkel999@gmail.com" class="text-brand-500 hover:text-brand-700 font-medium">Hubungi kami</a>
            </p>
        </div>
    </div>
</x-guest-layout>

            ...
            <div class="mb-6 bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100">
                <div class="p-5 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-900">Riwayat Donasi</p>
                            <p class="text-xs text-gray-500">Lihat semua donasi yang pernah Anda berikan.</p>
                        </div>
                    </div>
                    <a href="{{ url('/my-donations') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                        Lihat Riwayat →
                    </a>
                </div>
            </div>
